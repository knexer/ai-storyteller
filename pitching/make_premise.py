...
from pitching.ideation import make_ideas, function_registry as make_ideas_function_registry
from pitching.pick_best_idea import pick_best_idea, function_registry as pick_best_idea_function_registry

def function_registry():
    return dict({
        "forward_graph_input": forward_graph_input,
        "init_pick_best": init_pick_best,
    }, **pick_best_idea_function_registry(), **make_ideas_function_registry())
